...
var app = (function () {
    ...
    ***************************************************************************** */
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(br2, file$5, 31, 16, 797);
    			attr_dev(h1, "class", "text-center text-login svelte-bto1o5");
    			add_location(h1, file$5, 33, 6, 842);
    ...
    const file$3 = "src/components/Navbar/Navbar.svelte";
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(nav, file$3, 5, 4, 86);
    			add_location(div, file$3, 4, 2, 75);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
