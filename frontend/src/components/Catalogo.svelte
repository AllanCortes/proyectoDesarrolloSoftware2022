<script lang="ts">
	...
	let products = [];
	const tableHeading = ["productName", "price", "stock", "typeProduct", "description","dateAdded"];
	...
	<thead>
	  <tr>
		...
		<th class:highlighted={selectedHeader === heading}
			...
			{#if heading === selectedHeader && (selectedHeader=== "stock" || selectedHeader=== "dateAdded" || selectedHeader=== "typeProduct" || selectedHeader=== "price" )}	
